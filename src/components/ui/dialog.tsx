	...
	return (
		<div
			...
			className={cn(
				...
				// Desktop: normal flow, but fixed when dialog is at max height
				"sm:relative sm:border-t-0 sm:p-0 sm:mt-0 sm:sticky sm:bottom-0 sm:bg-background sm:border-t sm:pt-4",
				className,
			)}
			{...props}
		/>
