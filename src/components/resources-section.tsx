...
import { Calendar, Package, Plus, Trash2, Users } from "lucide-react";
					...
					<div className="space-y-6">
						{resources.map((resource) => (
							<div key={resource.id} className="border rounded-lg p-4">
								...
								{resource.consumptions.length === 0 ? (
									...
									<div className="space-y-3">
										...
										{resource.consumptions.map((consumption) => (
											<div
												key={consumption.id}
														...
														{consumption.consumptionMembers.map(
															(consumptionMember) => (
																...
																>
																	...
																	{consumptionMember.amount.toFixed(2)}
																</Badge>
															),
														)}
													</div>
